namespace GW2FOX
{
    partial class KainengBlackout
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(KainengBlackout));
            button9 = new Button();
            button8 = new Button();
            button7 = new Button();
            button5 = new Button();
            ...
            button3 = new Button();
            button2 = new Button();
            AttentionKainengBlackout = new TextBox();
            KainengBlackoutinstance = new TextBox();
            KainengBlackoutinfo = new TextBox();
            button1 = new Button();
            Symbols = new TextBox();
            Welcome = new TextBox();
            Guild = new TextBox();
            ...
            // 
            // AttentionKainengBlackout
            // 
            AttentionKainengBlackout.Font = new Font("Segoe UI", 15F);
            AttentionKainengBlackout.Location = new Point(1293, 439);
            AttentionKainengBlackout.Multiline = true;
            AttentionKainengBlackout.Name = "AttentionKainengBlackout";
            AttentionKainengBlackout.ReadOnly = true;
            AttentionKainengBlackout.ScrollBars = ScrollBars.Vertical;
            AttentionKainengBlackout.Size = new Size(600, 60);
            AttentionKainengBlackout.TabIndex = 58;
            AttentionKainengBlackout.Text = "≪ATTENTION≫ Meta -Train │ ☠Lvl 80 │ “Kaineng Blackout” │ ☣[&BBkNAAA=]☣ - Join us!";
            // 
            // KainengBlackoutinstance
            // 
            KainengBlackoutinstance.Font = new Font("Segoe UI", 15F);
            KainengBlackoutinstance.Location = new Point(653, 439);
            KainengBlackoutinstance.Multiline = true;
            KainengBlackoutinstance.Name = "KainengBlackoutinstance";
            KainengBlackoutinstance.ReadOnly = true;
            KainengBlackoutinstance.ScrollBars = ScrollBars.Vertical;
            KainengBlackoutinstance.Size = new Size(600, 60);
            KainengBlackoutinstance.TabIndex = 57;
            KainengBlackoutinstance.Text = "Go out of fight, then right click group 2 & join ☣New Kaineng City☣";
            // 
            // KainengBlackoutinfo
            // 
            KainengBlackoutinfo.BackColor = SystemColors.Highlight;
            KainengBlackoutinfo.Font = new Font("Segoe UI", 15F);
            KainengBlackoutinfo.Location = new Point(13, 439);
            KainengBlackoutinfo.Multiline = true;
            KainengBlackoutinfo.Name = "KainengBlackoutinfo";
            KainengBlackoutinfo.ReadOnly = true;
            KainengBlackoutinfo.ScrollBars = ScrollBars.Vertical;
            KainengBlackoutinfo.Size = new Size(600, 60);
            KainengBlackoutinfo.TabIndex = 56;
            KainengBlackoutinfo.Text = "☠Lvl 80 ≪Kaineng Blackout≫ │ ☣[&BBkNAAA=]☣";
            // 
            // button1
            // 
            ...
            Controls.Add(AttentionKainengBlackout);
            Controls.Add(KainengBlackoutinstance);
            Controls.Add(KainengBlackoutinfo);
        ...
        private TextBox AttentionKainengBlackout;
        private TextBox KainengBlackoutinstance;
        private TextBox KainengBlackoutinfo;
