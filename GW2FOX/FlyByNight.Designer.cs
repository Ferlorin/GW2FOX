namespace GW2FOX
{
    partial class FlyByNight
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FlyByNight));
            button9 = new Button();
            button8 = new Button();
            button7 = new Button();
            button5 = new Button();
            ...
            button3 = new Button();
            button2 = new Button();
            AttentionFlyByNight = new TextBox();
            FlyByNightinstance = new TextBox();
            FlyByNightinfo = new TextBox();
            button1 = new Button();
            Symbols = new TextBox();
            Welcome = new TextBox();
            Guild = new TextBox();
            ...
            // AttentionFlyByNight
            // 
            AttentionFlyByNight.Font = new Font("Segoe UI", 15F);
            AttentionFlyByNight.Location = new Point(1293, 439);
            AttentionFlyByNight.Multiline = true;
            AttentionFlyByNight.Name = "AttentionFlyByNight";
            AttentionFlyByNight.ReadOnly = true;
            AttentionFlyByNight.ScrollBars = ScrollBars.Vertical;
            AttentionFlyByNight.Size = new Size(600, 60);
            AttentionFlyByNight.TabIndex = 58;
            AttentionFlyByNight.Text = "≪ATTENTION≫ Meta -Train │ ☠Lvl 80 │ “Fly by Night” │ ☣[&BB8OAAA=]☣ - Join us!";
            // 
            // FlyByNightinstance
            // 
            FlyByNightinstance.Font = new Font("Segoe UI", 15F);
            FlyByNightinstance.Location = new Point(653, 439);
            FlyByNightinstance.Multiline = true;
            FlyByNightinstance.Name = "FlyByNightinstance";
            FlyByNightinstance.ReadOnly = true;
            FlyByNightinstance.ScrollBars = ScrollBars.Vertical;
            FlyByNightinstance.Size = new Size(600, 60);
            FlyByNightinstance.TabIndex = 57;
            FlyByNightinstance.Text = "Go out of fight, then right click group 2 & join ☣The Wizard's Tower☣";
            // 
            // FlyByNightinfo
            // 
            FlyByNightinfo.BackColor = SystemColors.Highlight;
            FlyByNightinfo.Font = new Font("Segoe UI", 15F);
            FlyByNightinfo.Location = new Point(13, 439);
            FlyByNightinfo.Multiline = true;
            FlyByNightinfo.Name = "FlyByNightinfo";
            FlyByNightinfo.ReadOnly = true;
            FlyByNightinfo.ScrollBars = ScrollBars.Vertical;
            FlyByNightinfo.Size = new Size(600, 60);
            FlyByNightinfo.TabIndex = 56;
            FlyByNightinfo.Text = "☠Lvl 80 ≪Fly by Night≫ │ ☣[&BB8OAAA=]☣";
            // 
            // button1
            // 
            ...
            Controls.Add(AttentionFlyByNight);
            Controls.Add(FlyByNightinstance);
            Controls.Add(FlyByNightinfo);
        ...
        private TextBox AttentionFlyByNight;
        private TextBox FlyByNightinstance;
        private TextBox FlyByNightinfo;
