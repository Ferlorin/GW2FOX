namespace GW2FOX
{
    partial class SaidrasHaven
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(SaidrasHaven));
            button9 = new Button();
            button8 = new Button();
            button7 = new Button();
            button5 = new Button();
            ...
            button3 = new Button();
            button2 = new Button();
            AttentionSaidrasHaven = new TextBox();
            SaidrasHaveninstance = new TextBox();
            SaidrasHaveninfo = new TextBox();
            button1 = new Button();
            Symbols = new TextBox();
            Welcome = new TextBox();
            Guild = new TextBox();
            ...
            // 
            // AttentionSaidrasHaven
            // 
            AttentionSaidrasHaven.Font = new Font("Segoe UI", 15F);
            AttentionSaidrasHaven.Location = new Point(1293, 439);
            AttentionSaidrasHaven.Multiline = true;
            AttentionSaidrasHaven.Name = "AttentionSaidrasHaven";
            AttentionSaidrasHaven.ReadOnly = true;
            AttentionSaidrasHaven.ScrollBars = ScrollBars.Vertical;
            AttentionSaidrasHaven.Size = new Size(600, 60);
            AttentionSaidrasHaven.TabIndex = 58;
            AttentionSaidrasHaven.Text = "≪ATTENTION≫ Meta -Train │ ☠Lvl 80 │ “Saidra's Haven” │ ☣[&BK0JAAA=]☣ - Join us!";
            // 
            // SaidrasHaveninstance
            // 
            SaidrasHaveninstance.Font = new Font("Segoe UI", 15F);
            SaidrasHaveninstance.Location = new Point(653, 439);
            SaidrasHaveninstance.Multiline = true;
            SaidrasHaveninstance.Name = "SaidrasHaveninstance";
            SaidrasHaveninstance.ReadOnly = true;
            SaidrasHaveninstance.ScrollBars = ScrollBars.Vertical;
            SaidrasHaveninstance.Size = new Size(600, 60);
            SaidrasHaveninstance.TabIndex = 57;
            SaidrasHaveninstance.Text = "Go out of fight, then right click group 2 & join ☣Lake Doric☣";
            // 
            // SaidrasHaveninfo
            // 
            SaidrasHaveninfo.BackColor = SystemColors.Highlight;
            SaidrasHaveninfo.Font = new Font("Segoe UI", 15F);
            SaidrasHaveninfo.Location = new Point(13, 439);
            SaidrasHaveninfo.Multiline = true;
            SaidrasHaveninfo.Name = "SaidrasHaveninfo";
            SaidrasHaveninfo.ReadOnly = true;
            SaidrasHaveninfo.ScrollBars = ScrollBars.Vertical;
            SaidrasHaveninfo.Size = new Size(600, 60);
            SaidrasHaveninfo.TabIndex = 56;
            SaidrasHaveninfo.Text = "☠Lvl 80 ≪Saidra's Haven≫ │ ☣[&BK0JAAA=]☣";
            // 
            // button1
            // 
            ...
            Controls.Add(AttentionSaidrasHaven);
            Controls.Add(SaidrasHaveninstance);
            Controls.Add(SaidrasHaveninfo);
        ...
        private TextBox AttentionSaidrasHaven;
        private TextBox SaidrasHaveninstance;
        private TextBox SaidrasHaveninfo;
