...
namespace GW2FOX
{
    public partial class FlyByNight : BaseForm
    {
        public FlyByNight()
        {
            InitializeComponent();
        ...
        private void Beheinfo_Click(object sender, EventArgs e)
        {
            ...
            Clipboard.SetText(FlyByNightinfo.Text);
        ...
        {
            // Copy the text from Mawinfo TextBox to the clipboard
            Clipboard.SetText(FlyByNightinstance.Text);
        ...
        {
            // Copy the text from Mawinfo TextBox to the clipboard
            Clipboard.SetText(AttentionFlyByNight.Text);
        ...
        private void button10_Click(object sender, EventArgs e)
        {
            try
            {
                string homepageUrl = "https://wiki.guildwars2.com/wiki/Wizard's_Tower:_Fly_by_Night";
