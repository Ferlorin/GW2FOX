namespace GW2FOX
{
    partial class Junglewurm
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Junglewurm));
            button13 = new Button();
            Junglewurminfos = new TextBox();
            button9 = new Button();
            button8 = new Button();
            button7 = new Button();
            button5 = new Button();
            ...
            button3 = new Button();
            button2 = new Button();
            Attentionjunglewurm = new TextBox();
            Junglewurminstance = new TextBox();
            Junglewurminfo = new TextBox();
            Back = new Button();
            Symbols = new TextBox();
            Welcome = new TextBox();
            Guild = new TextBox();
            ...
            // Junglewurminfos
            // 
            Junglewurminfos.BackColor = Color.Red;
            Junglewurminfos.Font = new Font("Segoe UI", 9F);
            Junglewurminfos.Location = new Point(490, 324);
            Junglewurminfos.Multiline = true;
            Junglewurminfos.Name = "Junglewurminfos";
            Junglewurminfos.ReadOnly = true;
            Junglewurminfos.ScrollBars = ScrollBars.Vertical;
            Junglewurminfos.Size = new Size(350, 39);
            Junglewurminfos.TabIndex = 96;
            Junglewurminfos.Text = "☠ Prepare at 25% to kill all 4 Husks from all 4 sides. Prefer East and North, then West and last South. Use CC & EMP!\r\n\r\n";
            // 
            // button9
            // 
            ...
            button7.Click += Junglewurminfo_Click;
            // 
            // button5
            // 
            ...
            // Attentionjunglewurm
            // 
            Attentionjunglewurm.Font = new Font("Segoe UI", 9F);
            Attentionjunglewurm.Location = new Point(15, 414);
            Attentionjunglewurm.Multiline = true;
            Attentionjunglewurm.Name = "Attentionjunglewurm";
            Attentionjunglewurm.ReadOnly = true;
            Attentionjunglewurm.ScrollBars = ScrollBars.Vertical;
            Attentionjunglewurm.Size = new Size(350, 39);
            ...
            // Junglewurminstance
            // 
            Junglewurminstance.Font = new Font("Segoe UI", 9F);
            Junglewurminstance.Location = new Point(15, 369);
            Junglewurminstance.Multiline = true;
            Junglewurminstance.Name = "Junglewurminstance";
            Junglewurminstance.ReadOnly = true;
            Junglewurminstance.ScrollBars = ScrollBars.Vertical;
            Junglewurminstance.Size = new Size(350, 39);
            Junglewurminstance.TabIndex = 86;
            Junglewurminstance.Text = "Go out of fight, then right click group 2 & join ☣Caledon Forest☣\r\n";
            // 
            // Junglewurminfo
            // 
            Junglewurminfo.BackColor = SystemColors.Highlight;
            Junglewurminfo.Font = new Font("Segoe UI", 9F);
            Junglewurminfo.Location = new Point(15, 324);
            Junglewurminfo.Multiline = true;
            Junglewurminfo.Name = "Junglewurminfo";
            Junglewurminfo.ReadOnly = true;
            Junglewurminfo.ScrollBars = ScrollBars.Vertical;
            Junglewurminfo.Size = new Size(350, 39);
            Junglewurminfo.TabIndex = 85;
            Junglewurminfo.Text = "☠Lvl 15 ≪Great Jungle Wurm≫ with Achievement “Don’t feed the Beast!”  │ ☣[&BD4BAAA=]☣\r\n";
            // 
            // Back
            // 
            ...
            Controls.Add(Junglewurminstance);
            Controls.Add(Junglewurminfo);
            Controls.Add(Back);
        ...
        private TextBox Junglewurminfos;
        ...
        private TextBox Attentionjunglewurm;
        private TextBox Junglewurminstance;
        private TextBox Junglewurminfo;
        private Button Back;
