...
namespace GW2FOX
{
    public partial class GatesOfArah : BaseForm
    {
        public GatesOfArah()
        {
            InitializeComponent();
        ...
        private async Task LoadItemPriceInformation()
        {
            try
            {
                ...
                {
                    string apiUrl = "https://api.guildwars2.com/v2/items/39471";
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            try
            {
                string homepageUrl = "https://wiki.guildwars2.com/wiki/Gates_of_Arah";
