namespace GW2FOX
{
    partial class Spellmaster
    {
        ...
        private void InitializeComponent()
        {
            ...
            Beheinfo.Text = "☠ ≪Night and the Enemy≫ │ ☣[&BNUHAAA=]☣";
            // 
            // Back
            // 
            ...
            // Canopy
            // 
            Canopy.BackColor = Color.Red;
            Canopy.Font = new Font("Segoe UI", 9F);
            Canopy.Location = new Point(490, 324);
            Canopy.Multiline = true;
            Canopy.Name = "Canopy";
            Canopy.ReadOnly = true;
            Canopy.ScrollBars = ScrollBars.Vertical;
            Canopy.Size = new Size(350, 39);
            Canopy.TabIndex = 80;
            ...
            Mapinfo.TabIndex = 82;
            Mapinfo.Text = "≪ATTENTION≫ Meta-Infusion-Train │ “Night and the Enemy ” │ ☣[&BNUHAAA=]☣  - Join us and take the Charr Helicopter up to the Canopy.";
            // 
            // pictureBox4
            // 
