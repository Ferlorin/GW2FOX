namespace GW2FOX
{
    partial class TheOilFloes
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(TheOilFloes));
            button9 = new Button();
            button8 = new Button();
            button7 = new Button();
            button5 = new Button();
            ...
            button3 = new Button();
            button2 = new Button();
            AttentionOil = new TextBox();
            Oilinstance = new TextBox();
            OilInfo = new TextBox();
            button1 = new Button();
            Symbols = new TextBox();
            Welcome = new TextBox();
            ...
            // AttentionOil
            // 
            AttentionOil.Font = new Font("Segoe UI", 15F);
            AttentionOil.Location = new Point(1293, 439);
            AttentionOil.Multiline = true;
            AttentionOil.Name = "AttentionOil";
            AttentionOil.ReadOnly = true;
            AttentionOil.ScrollBars = ScrollBars.Vertical;
            AttentionOil.Size = new Size(600, 60);
            AttentionOil.TabIndex = 58;
            AttentionOil.Text = "≪ATTENTION≫ Meta -Train │ ☠Lvl 80 │ “The Oil Floes” │ ☣[&BKYLAAA=]☣ - Join us!";
            // 
            // Oilinstance
            // 
            Oilinstance.Font = new Font("Segoe UI", 15F);
            Oilinstance.Location = new Point(653, 439);
            Oilinstance.Multiline = true;
            Oilinstance.Name = "Oilinstance";
            Oilinstance.ReadOnly = true;
            Oilinstance.ScrollBars = ScrollBars.Vertical;
            Oilinstance.Size = new Size(600, 60);
            Oilinstance.TabIndex = 57;
            Oilinstance.Text = "Go out of fight, then right click group 2 & join ☣Thunderhead Peaks☣";
            // 
            // OilInfo
            // 
            OilInfo.BackColor = SystemColors.Highlight;
            OilInfo.Font = new Font("Segoe UI", 15F);
            OilInfo.Location = new Point(13, 439);
            OilInfo.Multiline = true;
            OilInfo.Name = "OilInfo";
            OilInfo.ReadOnly = true;
            OilInfo.ScrollBars = ScrollBars.Vertical;
            OilInfo.Size = new Size(600, 60);
            OilInfo.TabIndex = 56;
            OilInfo.Text = "☠Lvl 80 ≪The Oil Floes≫ │ ☣[&BKYLAAA=]☣";
            // 
            // button1
            // 
            ...
            Controls.Add(AttentionOil);
            Controls.Add(Oilinstance);
            Controls.Add(OilInfo);
        ...
        private TextBox AttentionOil;
        private TextBox Oilinstance;
        private TextBox OilInfo;
