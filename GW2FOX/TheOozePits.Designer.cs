namespace GW2FOX
{
    partial class TheOozePits
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(TheOozePits));
            button9 = new Button();
            button8 = new Button();
            button7 = new Button();
            button5 = new Button();
            ...
            button3 = new Button();
            button2 = new Button();
            Oozebehe = new TextBox();
            Oozeinfo = new TextBox();
            button1 = new Button();
            Symbols = new TextBox();
            Welcome = new TextBox();
            Guild = new TextBox();
            ...
            // Oozebehe
            // 
            Oozebehe.Font = new Font("Segoe UI", 15F);
            Oozebehe.Location = new Point(1293, 439);
            Oozebehe.Multiline = true;
            Oozebehe.Name = "Oozebehe";
            Oozebehe.ReadOnly = true;
            Oozebehe.ScrollBars = ScrollBars.Vertical;
            Oozebehe.Size = new Size(600, 60);
            Oozebehe.TabIndex = 58;
            Oozebehe.Text = "≪ATTENTION≫ Meta -Train │ ☠Lvl 80 │ “The Ooze Pits” │ ☣[&BPgLAAA=]☣ - Join us!";
            // 
            // Oozeinfo
            // 
            Oozeinfo.BackColor = SystemColors.Highlight;
            Oozeinfo.Font = new Font("Segoe UI", 15F);
            Oozeinfo.Location = new Point(13, 439);
            Oozeinfo.Multiline = true;
            Oozeinfo.Name = "Oozeinfo";
            Oozeinfo.ReadOnly = true;
            Oozeinfo.ScrollBars = ScrollBars.Vertical;
            Oozeinfo.Size = new Size(600, 60);
            Oozeinfo.TabIndex = 56;
            Oozeinfo.Text = "☠Lvl 80 ≪The Ooze Pits≫ │ ☣[&BPgLAAA=]☣";
            // 
            // button1
            // 
            ...
            // OozeInstance
            // 
            OozeInstance.BackColor = SystemColors.Highlight;
            OozeInstance.Font = new Font("Segoe UI", 15F);
            OozeInstance.Location = new Point(653, 439);
            OozeInstance.Multiline = true;
            OozeInstance.Name = "OozeInstance";
            OozeInstance.ReadOnly = true;
            OozeInstance.ScrollBars = ScrollBars.Vertical;
            OozeInstance.Size = new Size(600, 60);
            ...
            Controls.Add(Oozebehe);
            Controls.Add(Oozeinfo);
        ...
        private TextBox Oozebehe;
        private TextBox Beheinstance;
        private TextBox Oozeinfo;
