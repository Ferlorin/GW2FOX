namespace GW2FOX
{
    partial class StormsOfWinter
    {
        ...
        private void InitializeComponent()
        {
            ...
            button3 = new Button();
            button2 = new Button();
            AttentionStormsOfWinter = new TextBox();
            StormsOfWinterinstance = new TextBox();
            StormsOfWinterinfo = new TextBox();
            button1 = new Button();
            Symbols = new TextBox();
            Welcome = new TextBox();
            Guild = new TextBox();
            ...
            // 
            // AttentionStormsOfWinter
            // 
            AttentionStormsOfWinter.Font = new Font("Segoe UI", 15F);
            AttentionStormsOfWinter.Location = new Point(1293, 439);
            AttentionStormsOfWinter.Multiline = true;
            AttentionStormsOfWinter.Name = "AttentionStormsOfWinter";
            AttentionStormsOfWinter.ReadOnly = true;
            AttentionStormsOfWinter.ScrollBars = ScrollBars.Vertical;
            AttentionStormsOfWinter.Size = new Size(600, 60);
            AttentionStormsOfWinter.TabIndex = 58;
            AttentionStormsOfWinter.Text = "≪ATTENTION≫ Meta -Train │ ☠Lvl 80 │ “Storms of Winter” │ ☣[&BCEMAAA=]☣ - Join us!";
            // 
            // StormsOfWinterinstance
            // 
            StormsOfWinterinstance.Font = new Font("Segoe UI", 15F);
            StormsOfWinterinstance.Location = new Point(653, 439);
            StormsOfWinterinstance.Multiline = true;
            StormsOfWinterinstance.Name = "StormsOfWinterinstance";
            StormsOfWinterinstance.ReadOnly = true;
            StormsOfWinterinstance.ScrollBars = ScrollBars.Vertical;
            StormsOfWinterinstance.Size = new Size(600, 60);
            StormsOfWinterinstance.TabIndex = 57;
            StormsOfWinterinstance.Text = "Go out of fight, then right click group 2 & join ☣Bjora Marches☣";
            // 
            // StormsOfWinterinfo
            // 
            StormsOfWinterinfo.BackColor = SystemColors.Highlight;
            StormsOfWinterinfo.Font = new Font("Segoe UI", 15F);
            StormsOfWinterinfo.Location = new Point(13, 439);
            StormsOfWinterinfo.Multiline = true;
            StormsOfWinterinfo.Name = "StormsOfWinterinfo";
            StormsOfWinterinfo.ReadOnly = true;
            StormsOfWinterinfo.ScrollBars = ScrollBars.Vertical;
            StormsOfWinterinfo.Size = new Size(600, 60);
            StormsOfWinterinfo.TabIndex = 56;
            StormsOfWinterinfo.Text = "☠Lvl 80 ≪Storms of Winter≫│ ☣[&BCEMAAA=]☣";
            // 
            // button1
            // 
            ...
            Controls.Add(AttentionStormsOfWinter);
            Controls.Add(StormsOfWinterinstance);
            Controls.Add(StormsOfWinterinfo);
        ...
        private TextBox AttentionStormsOfWinter;
        private TextBox StormsOfWinterinstance;
        private TextBox StormsOfWinterinfo;
