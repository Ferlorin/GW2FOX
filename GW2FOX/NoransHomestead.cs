...
namespace GW2FOX
{
    public partial class NoransHomestead : BaseForm
    {
        ...
        private void Beheinfo_Click(object sender, EventArgs e)
        {
            ...
            Clipboard.SetText(NewLoamhurstinfo.Text);
        ...
        {
            // Copy the text from Mawinfo TextBox to the clipboard
            Clipboard.SetText(NewLoamhurstinstance.Text);
        ...
        {
            // Copy the text from Mawinfo TextBox to the clipboard
            Clipboard.SetText(AttentionNewLoamhurst.Text);
        ...
        private void button10_Click(object sender, EventArgs e)
        {
            try
            {
                string homepageUrl = "https://wiki.guildwars2.com/wiki/White_Mantle_Control:_Noran's_Homestead";
