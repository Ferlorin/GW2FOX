namespace GW2FOX
{
    partial class Spellmaster
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Spellmaster));
            button8 = new Button();
            button7 = new Button();
            button5 = new Button();
            button4 = new Button();
            ...
            Beheinstance.Text = "Go out of fight, then right click group 2 & join ☣Verdant Brink☣\r\n";
            // 
            // Beheinfo
            // 
            ...
            Beheinfo.Text = "☠ ≪Mordrem Champions & Legendary Spellmaster Macsen≫ ☣[&BNUHAAA=]☣";
            // 
            // button1
            // 
            ...
            button6.Click += Canopy_Click;
            // 
            // Canopy
            // 
            Canopy.Font = new Font("Segoe UI", 15F);
            Canopy.Location = new Point(12, 570);
            Canopy.Multiline = true;
            Canopy.Name = "Canopy";
            Canopy.ReadOnly = true;
            Canopy.ScrollBars = ScrollBars.Vertical;
            Canopy.Size = new Size(600, 60);
            Canopy.TabIndex = 80;
            Canopy.Text = "☠ Take the Charr Helicopter up to the Canopy.\r\n";
            // 
            // button9
            // 
            button9.Location = new Point(1290, 505);
            button9.Name = "button9";
            button9.Size = new Size(75, 23);
            button9.TabIndex = 83;
            button9.Text = "Copy";
            button9.UseVisualStyleBackColor = true;
            button9.Click += Mapinfo_Click;
            // 
            // Mapinfo
            // 
            ...
            Mapinfo.TabIndex = 82;
            Mapinfo.Text = "≪ATTENTION≫ Meta-Infusion-Train │ “Mordrem Champions & Legendary Spellmaster Macsen” │ ☣[&BNUHAAA=]☣  - Join us and take the Charr Helicopter up to the Canopy.";
            // 
            // pictureBox5
            // 
