namespace GW2FOX
{
    partial class Aspenwood
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Aspenwood));
            button9 = new Button();
            button8 = new Button();
            button7 = new Button();
            button5 = new Button();
            ...
            button3 = new Button();
            button2 = new Button();
            AttentionAspenwood = new TextBox();
            Aspenwoodinstance = new TextBox();
            Aspenwoodinfo = new TextBox();
            button1 = new Button();
            Symbols = new TextBox();
            Welcome = new TextBox();
            Guild = new TextBox();
            ...
            // AttentionAspenwood
            // 
            AttentionAspenwood.Font = new Font("Segoe UI", 15F);
            AttentionAspenwood.Location = new Point(1293, 439);
            AttentionAspenwood.Multiline = true;
            AttentionAspenwood.Name = "AttentionAspenwood";
            AttentionAspenwood.ReadOnly = true;
            AttentionAspenwood.ScrollBars = ScrollBars.Vertical;
            AttentionAspenwood.Size = new Size(600, 60);
            AttentionAspenwood.TabIndex = 58;
            AttentionAspenwood.Text = "≪ATTENTION≫ Meta -Train │ ☠Lvl 80 │ “Aspenwood” │ ☣[&BPkMAAA=]☣ - Join us!";
            // 
            // Aspenwoodinstance
            // 
            Aspenwoodinstance.Font = new Font("Segoe UI", 15F);
            Aspenwoodinstance.Location = new Point(653, 439);
            Aspenwoodinstance.Multiline = true;
            Aspenwoodinstance.Name = "Aspenwoodinstance";
            Aspenwoodinstance.ReadOnly = true;
            Aspenwoodinstance.ScrollBars = ScrollBars.Vertical;
            Aspenwoodinstance.Size = new Size(600, 60);
            Aspenwoodinstance.TabIndex = 57;
            Aspenwoodinstance.Text = "Go out of fight, then right click group 2 & join ☣The Echovald Wilds☣";
            // 
            // Aspenwoodinfo
            // 
            Aspenwoodinfo.BackColor = SystemColors.Highlight;
            Aspenwoodinfo.Font = new Font("Segoe UI", 15F);
            Aspenwoodinfo.Location = new Point(13, 439);
            Aspenwoodinfo.Multiline = true;
            Aspenwoodinfo.Name = "Aspenwoodinfo";
            Aspenwoodinfo.ReadOnly = true;
            Aspenwoodinfo.ScrollBars = ScrollBars.Vertical;
            Aspenwoodinfo.Size = new Size(600, 60);
            Aspenwoodinfo.TabIndex = 56;
            Aspenwoodinfo.Text = "☠Lvl 80 ≪Aspenwood≫ │ ☣[&BPkMAAA=]☣";
            // 
            // button1
            // 
            ...
            Controls.Add(AttentionAspenwood);
            Controls.Add(Aspenwoodinstance);
            Controls.Add(Aspenwoodinfo);
        ...
        private TextBox AttentionAspenwood;
        private TextBox Aspenwoodinstance;
        private TextBox Aspenwoodinfo;
