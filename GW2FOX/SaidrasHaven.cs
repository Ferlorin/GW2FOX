...
namespace GW2FOX
{
    public partial class SaidrasHaven : BaseForm
    {
        public SaidrasHaven()
        {
            InitializeComponent();
        ...
        private void Beheinfo_Click(object sender, EventArgs e)
        {
            ...
            Clipboard.SetText(SaidrasHaveninfo.Text);
        ...
        {
            // Copy the text from Mawinfo TextBox to the clipboard
            Clipboard.SetText(SaidrasHaveninstance.Text);
        ...
        {
            // Copy the text from Mawinfo TextBox to the clipboard
            Clipboard.SetText(AttentionSaidrasHaven.Text);
        ...
        private void button10_Click(object sender, EventArgs e)
        {
            try
            {
                string homepageUrl = "https://wiki.guildwars2.com/wiki/White_Mantle_Control:_Saidra's_Haven";
