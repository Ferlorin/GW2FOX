...
namespace GW2FOX
{
    public partial class Convergences : BaseForm
    {
        public Convergences()
        {
            InitializeComponent();
        ...
        private void Beheinfo_Click(object sender, EventArgs e)
        {
            ...
            Clipboard.SetText(Convergencesinfo.Text);
        ...
        {
            // Copy the text from Mawinfo TextBox to the clipboard
            Clipboard.SetText(Convergencesinstance.Text);
        ...
        {
            // Copy the text from Mawinfo TextBox to the clipboard
            Clipboard.SetText(AttentionConvergences.Text);
        ...
        private void button10_Click(object sender, EventArgs e)
        {
            try
            {
                string homepageUrl = "https://wiki.guildwars2.com/wiki/Convergences";
