namespace GW2FOX
{
    partial class DefendJorasKeep
    {
        ...
        private void InitializeComponent()
        {
            ...
            button3 = new Button();
            button2 = new Button();
            AttentionDefendJorasKeep = new TextBox();
            DefendJorasKeepinstance = new TextBox();
            DefendJorasKeepinfo = new TextBox();
            button1 = new Button();
            Symbols = new TextBox();
            Welcome = new TextBox();
            Guild = new TextBox();
            ...
            // 
            // AttentionDefendJorasKeep
            // 
            AttentionDefendJorasKeep.Font = new Font("Segoe UI", 15F);
            AttentionDefendJorasKeep.Location = new Point(1293, 439);
            AttentionDefendJorasKeep.Multiline = true;
            AttentionDefendJorasKeep.Name = "AttentionDefendJorasKeep";
            AttentionDefendJorasKeep.ReadOnly = true;
            AttentionDefendJorasKeep.ScrollBars = ScrollBars.Vertical;
            AttentionDefendJorasKeep.Size = new Size(600, 60);
            AttentionDefendJorasKeep.TabIndex = 58;
            AttentionDefendJorasKeep.Text = "≪ATTENTION≫ Meta -Train │ ☠Lvl 80 │ “Defend Jora's Keep” │ ☣[&BCcMAAA=]☣ - Join us!";
            // 
            // DefendJorasKeepinstance
            // 
            DefendJorasKeepinstance.Font = new Font("Segoe UI", 15F);
            DefendJorasKeepinstance.Location = new Point(653, 439);
            DefendJorasKeepinstance.Multiline = true;
            DefendJorasKeepinstance.Name = "DefendJorasKeepinstance";
            DefendJorasKeepinstance.ReadOnly = true;
            DefendJorasKeepinstance.ScrollBars = ScrollBars.Vertical;
            DefendJorasKeepinstance.Size = new Size(600, 60);
            DefendJorasKeepinstance.TabIndex = 57;
            DefendJorasKeepinstance.Text = "Go out of fight, then right click group 2 & join ☣Bjora Marches☣";
            // 
            // DefendJorasKeepinfo
            // 
            DefendJorasKeepinfo.BackColor = SystemColors.Highlight;
            DefendJorasKeepinfo.Font = new Font("Segoe UI", 15F);
            DefendJorasKeepinfo.Location = new Point(13, 439);
            DefendJorasKeepinfo.Multiline = true;
            DefendJorasKeepinfo.Name = "DefendJorasKeepinfo";
            DefendJorasKeepinfo.ReadOnly = true;
            DefendJorasKeepinfo.ScrollBars = ScrollBars.Vertical;
            DefendJorasKeepinfo.Size = new Size(600, 60);
            DefendJorasKeepinfo.TabIndex = 56;
            DefendJorasKeepinfo.Text = "☠Lvl 80 ≪Defend Jora's Keep≫ │ ☣[&BCcMAAA=]☣";
            // 
            // button1
            // 
            ...
            Controls.Add(AttentionDefendJorasKeep);
            Controls.Add(DefendJorasKeepinstance);
            Controls.Add(DefendJorasKeepinfo);
        ...
        private TextBox AttentionDefendJorasKeep;
        private TextBox DefendJorasKeepinstance;
        private TextBox DefendJorasKeepinfo;
