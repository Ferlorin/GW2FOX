namespace GW2FOX
{
    partial class MawsOfTorement
    {
        ...
        private void InitializeComponent()
        {
            ...
            button3 = new Button();
            button2 = new Button();
            AttentionMaws = new TextBox();
            Mawsinstance = new TextBox();
            Mawsinfo = new TextBox();
            button1 = new Button();
            Symbols = new TextBox();
            Welcome = new TextBox();
            Guild = new TextBox();
            ...
            // AttentionMaws
            // 
            AttentionMaws.Font = new Font("Segoe UI", 15F);
            AttentionMaws.Location = new Point(1293, 439);
            AttentionMaws.Multiline = true;
            AttentionMaws.Name = "AttentionMaws";
            AttentionMaws.ReadOnly = true;
            AttentionMaws.ScrollBars = ScrollBars.Vertical;
            AttentionMaws.Size = new Size(600, 60);
            AttentionMaws.TabIndex = 58;
            AttentionMaws.Text = "≪ATTENTION≫ Meta -Train │ ☠Lvl 80 │ “Maws of Torment” │ ☣[&BKMKAAA=]☣ - Join us!";
            // 
            // Mawsinstance
            // 
            Mawsinstance.Font = new Font("Segoe UI", 15F);
            Mawsinstance.Location = new Point(653, 439);
            Mawsinstance.Multiline = true;
            Mawsinstance.Name = "Mawsinstance";
            Mawsinstance.ReadOnly = true;
            Mawsinstance.ScrollBars = ScrollBars.Vertical;
            Mawsinstance.Size = new Size(600, 60);
            Mawsinstance.TabIndex = 57;
            Mawsinstance.Text = "Go out of fight, then right click group 2 & join ☣The Desolation☣";
            // 
            // Mawsinfo
            // 
            Mawsinfo.BackColor = SystemColors.Highlight;
            Mawsinfo.Font = new Font("Segoe UI", 15F);
            Mawsinfo.Location = new Point(13, 439);
            Mawsinfo.Multiline = true;
            Mawsinfo.Name = "Mawsinfo";
            Mawsinfo.ReadOnly = true;
            Mawsinfo.ScrollBars = ScrollBars.Vertical;
            Mawsinfo.Size = new Size(600, 60);
            Mawsinfo.TabIndex = 56;
            Mawsinfo.Text = "☠Lvl 80 ≪Maws of Torment│ ☣[&BKMKAAA=]☣";
            // 
            // button1
            // 
            ...
            Controls.Add(AttentionMaws);
            Controls.Add(Mawsinstance);
            Controls.Add(Mawsinfo);
        ...
        private TextBox AttentionMaws;
        private TextBox Mawsinstance;
        private TextBox Mawsinfo;
