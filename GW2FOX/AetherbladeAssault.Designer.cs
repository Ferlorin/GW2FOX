namespace GW2FOX
{
    partial class AetherbladeAssault
    {
        /// <summary>
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(AetherbladeAssault));
            button9 = new Button();
            button8 = new Button();
            button7 = new Button();
            button5 = new Button();
            ...
            button3 = new Button();
            button2 = new Button();
            AttentionAetherbladeAssault = new TextBox();
            AetherbladeAssaultinstance = new TextBox();
            AetherbladeAssaultinfo = new TextBox();
            button1 = new Button();
            Symbols = new TextBox();
            Welcome = new TextBox();
            Guild = new TextBox();
            ...
            // 
            // AttentionAetherbladeAssault
            // 
            AttentionAetherbladeAssault.Font = new Font("Segoe UI", 15F);
            AttentionAetherbladeAssault.Location = new Point(1293, 439);
            AttentionAetherbladeAssault.Multiline = true;
            AttentionAetherbladeAssault.Name = "AttentionAetherbladeAssault";
            AttentionAetherbladeAssault.ReadOnly = true;
            AttentionAetherbladeAssault.ScrollBars = ScrollBars.Vertical;
            AttentionAetherbladeAssault.Size = new Size(600, 60);
            AttentionAetherbladeAssault.TabIndex = 58;
            AttentionAetherbladeAssault.Text = "≪ATTENTION≫ Meta -Train │ ☠Lvl 80 │ “Aetherblade Assault” │ ☣[&BGUNAAA=]☣ - Join us!";
            // 
            // AetherbladeAssaultinstance
            // 
            AetherbladeAssaultinstance.Font = new Font("Segoe UI", 15F);
            AetherbladeAssaultinstance.Location = new Point(653, 439);
            AetherbladeAssaultinstance.Multiline = true;
            AetherbladeAssaultinstance.Name = "AetherbladeAssaultinstance";
            AetherbladeAssaultinstance.ReadOnly = true;
            AetherbladeAssaultinstance.ScrollBars = ScrollBars.Vertical;
            AetherbladeAssaultinstance.Size = new Size(600, 60);
            AetherbladeAssaultinstance.TabIndex = 57;
            AetherbladeAssaultinstance.Text = "Go out of fight, then right click group 2 & join ☣Seitung Province☣";
            // 
            // AetherbladeAssaultinfo
            // 
            AetherbladeAssaultinfo.BackColor = SystemColors.Highlight;
            AetherbladeAssaultinfo.Font = new Font("Segoe UI", 15F);
            AetherbladeAssaultinfo.Location = new Point(13, 439);
            AetherbladeAssaultinfo.Multiline = true;
            AetherbladeAssaultinfo.Name = "AetherbladeAssaultinfo";
            AetherbladeAssaultinfo.ReadOnly = true;
            AetherbladeAssaultinfo.ScrollBars = ScrollBars.Vertical;
            AetherbladeAssaultinfo.Size = new Size(600, 60);
            AetherbladeAssaultinfo.TabIndex = 56;
            AetherbladeAssaultinfo.Text = "☠Lvl 80 ≪Aetherblade Assault≫ │ ☣[&BGUNAAA=]☣";
            // 
            // button1
            // 
            ...
            Controls.Add(AttentionAetherbladeAssault);
            Controls.Add(AetherbladeAssaultinstance);
            Controls.Add(AetherbladeAssaultinfo);
        ...
        private TextBox AttentionAetherbladeAssault;
        private TextBox AetherbladeAssaultinstance;
        private TextBox AetherbladeAssaultinfo;
