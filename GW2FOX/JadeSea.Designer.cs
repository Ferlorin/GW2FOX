namespace GW2FOX
{
    partial class JadeSea
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(JadeSea));
            button9 = new Button();
            button8 = new Button();
            button7 = new Button();
            button5 = new Button();
            ...
            button3 = new Button();
            button2 = new Button();
            AttentionJadeSea = new TextBox();
            JadeSeainstance = new TextBox();
            JadeSeainfo = new TextBox();
            button1 = new Button();
            Symbols = new TextBox();
            Welcome = new TextBox();
            Guild = new TextBox();
            ...
            // AttentionJadeSea
            // 
            AttentionJadeSea.Font = new Font("Segoe UI", 15F);
            AttentionJadeSea.Location = new Point(1293, 439);
            AttentionJadeSea.Multiline = true;
            AttentionJadeSea.Name = "AttentionJadeSea";
            AttentionJadeSea.ReadOnly = true;
            AttentionJadeSea.ScrollBars = ScrollBars.Vertical;
            AttentionJadeSea.Size = new Size(600, 60);
            AttentionJadeSea.TabIndex = 58;
            AttentionJadeSea.Text = "≪ATTENTION≫ Meta -Train │ ☠Lvl 80 │ “The Battle for the Jade Sea” │ ☣[&BKIMAAA=]☣ - Join us!";
            // 
            // JadeSeainstance
            // 
            JadeSeainstance.Font = new Font("Segoe UI", 15F);
            JadeSeainstance.Location = new Point(653, 439);
            JadeSeainstance.Multiline = true;
            JadeSeainstance.Name = "JadeSeainstance";
            JadeSeainstance.ReadOnly = true;
            JadeSeainstance.ScrollBars = ScrollBars.Vertical;
            JadeSeainstance.Size = new Size(600, 60);
            JadeSeainstance.TabIndex = 57;
            JadeSeainstance.Text = "Go out of fight, then right click group 2 & join ☣Dragon's End☣";
            // 
            // JadeSeainfo
            // 
            JadeSeainfo.BackColor = SystemColors.Highlight;
            JadeSeainfo.Font = new Font("Segoe UI", 15F);
            JadeSeainfo.Location = new Point(13, 439);
            JadeSeainfo.Multiline = true;
            JadeSeainfo.Name = "JadeSeainfo";
            JadeSeainfo.ReadOnly = true;
            JadeSeainfo.ScrollBars = ScrollBars.Vertical;
            JadeSeainfo.Size = new Size(600, 60);
            JadeSeainfo.TabIndex = 56;
            JadeSeainfo.Text = "☠Lvl 80 ≪The Battle for the Jade Sea≫ │ ☣[&BKIMAAA=]☣";
            // 
            // button1
            // 
            ...
            Controls.Add(AttentionJadeSea);
            Controls.Add(JadeSeainstance);
            Controls.Add(JadeSeainfo);
        ...
        private TextBox AttentionJadeSea;
        private TextBox JadeSeainstance;
        private TextBox JadeSeainfo;
