...
namespace GW2FOX
{
    public partial class DefendJorasKeep : BaseForm
    {
        public DefendJorasKeep()
        {
            InitializeComponent();
        ...
        private void Beheinfo_Click(object sender, EventArgs e)
        {
            ...
            Clipboard.SetText(DefendJorasKeepinfo.Text);
        ...
        {
            // Copy the text from Mawinfo TextBox to the clipboard
            Clipboard.SetText(DefendJorasKeepinstance.Text);
        ...
        {
            // Copy the text from Mawinfo TextBox to the clipboard
            Clipboard.SetText(AttentionDefendJorasKeep.Text);
