namespace GW2FOX
{
    partial class GangWar
    {
        ...
        private void InitializeComponent()
        {
            ...
            // AttentionGangWar
            // 
            AttentionGangWar.Font = new Font("Segoe UI", 15F);
            AttentionGangWar.Location = new Point(1293, 439);
            AttentionGangWar.Multiline = true;
            AttentionGangWar.Name = "AttentionGangWar";
            AttentionGangWar.ReadOnly = true;
            AttentionGangWar.ScrollBars = ScrollBars.Vertical;
            AttentionGangWar.Size = new Size(600, 60);
            AttentionGangWar.TabIndex = 58;
            AttentionGangWar.Text = "≪ATTENTION≫ Meta -Train │ ☠Lvl 80 │ “The Gang War of Echovald” │ ☣[&BMwMAAA=]☣ - Join us!";
            // 
            // GangWarinstance
            // 
            GangWarinstance.Font = new Font("Segoe UI", 15F);
            GangWarinstance.Location = new Point(653, 439);
            GangWarinstance.Multiline = true;
            GangWarinstance.Name = "GangWarinstance";
            GangWarinstance.ReadOnly = true;
            GangWarinstance.ScrollBars = ScrollBars.Vertical;
            GangWarinstance.Size = new Size(600, 60);
            GangWarinstance.TabIndex = 57;
            GangWarinstance.Text = "Go out of fight, then right click group 2 & join ☣The Echovald Wilds☣";
            // 
            // GangWarinfo
            // 
            GangWarinfo.BackColor = SystemColors.Highlight;
            GangWarinfo.Font = new Font("Segoe UI", 15F);
            GangWarinfo.Location = new Point(13, 439);
            GangWarinfo.Multiline = true;
            GangWarinfo.Name = "GangWarinfo";
            GangWarinfo.ReadOnly = true;
            GangWarinfo.ScrollBars = ScrollBars.Vertical;
            GangWarinfo.Size = new Size(600, 60);
            GangWarinfo.TabIndex = 56;
            GangWarinfo.Text = "☠Lvl 80 ≪The Gang War of Echovald≫ │ ☣[&BMwMAAA=]☣";
            // 
            // button1
            // 
