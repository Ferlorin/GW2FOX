namespace GW2FOX
{
    partial class Effigy
    {
        ...
        private void InitializeComponent()
        {
            ...
            button3 = new Button();
            button2 = new Button();
            AttentionEffigy = new TextBox();
            Effigyinstance = new TextBox();
            Effigyinfo = new TextBox();
            button1 = new Button();
            Symbols = new TextBox();
            Welcome = new TextBox();
            Guild = new TextBox();
            ...
            // AttentionEffigy
            // 
            AttentionEffigy.Font = new Font("Segoe UI", 15F);
            AttentionEffigy.Location = new Point(1293, 439);
            AttentionEffigy.Multiline = true;
            AttentionEffigy.Name = "AttentionEffigy";
            AttentionEffigy.ReadOnly = true;
            AttentionEffigy.ScrollBars = ScrollBars.Vertical;
            AttentionEffigy.Size = new Size(600, 60);
            AttentionEffigy.TabIndex = 58;
            AttentionEffigy.Text = "≪ATTENTION≫ Meta -Train │ ☠Lvl 80 │ “Effigy” │ ☣[&BA4MAAA=]☣ - Join us!";
            // 
            // Effigyinstance
            // 
            Effigyinstance.Font = new Font("Segoe UI", 15F);
            Effigyinstance.Location = new Point(653, 439);
            Effigyinstance.Multiline = true;
            Effigyinstance.Name = "Effigyinstance";
            Effigyinstance.ReadOnly = true;
            Effigyinstance.ScrollBars = ScrollBars.Vertical;
            Effigyinstance.Size = new Size(600, 60);
            Effigyinstance.TabIndex = 57;
            Effigyinstance.Text = "Go out of fight, then right click group 2 & join ☣Grothmar Valley☣";
            // 
            // Effigyinfo
            // 
            Effigyinfo.BackColor = SystemColors.Highlight;
            Effigyinfo.Font = new Font("Segoe UI", 15F);
            Effigyinfo.Location = new Point(13, 439);
            Effigyinfo.Multiline = true;
            Effigyinfo.Name = "Effigyinfo";
            Effigyinfo.ReadOnly = true;
            Effigyinfo.ScrollBars = ScrollBars.Vertical;
            Effigyinfo.Size = new Size(600, 60);
            Effigyinfo.TabIndex = 56;
            Effigyinfo.Text = "☠Lvl 80 ≪Effigy│ ☣[&BA4MAAA=]☣";
            // 
            // button1
            // 
            ...
            Controls.Add(AttentionEffigy);
            Controls.Add(Effigyinstance);
            Controls.Add(Effigyinfo);
        ...
        private TextBox AttentionEffigy;
        private TextBox Effigyinstance;
        private TextBox Effigyinfo;
