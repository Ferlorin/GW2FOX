namespace GW2FOX
{
    partial class Sandstorm
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Sandstorm));
            button9 = new Button();
            button8 = new Button();
            button7 = new Button();
            button5 = new Button();
            ...
            button3 = new Button();
            button2 = new Button();
            AttentionSandstorm = new TextBox();
            Sandstorminstance = new TextBox();
            Sandstorminfo = new TextBox();
            button1 = new Button();
            Symbols = new TextBox();
            Welcome = new TextBox();
            Guild = new TextBox();
            ...
            // AttentionSandstorm
            // 
            AttentionSandstorm.Font = new Font("Segoe UI", 15F);
            AttentionSandstorm.Location = new Point(1293, 439);
            AttentionSandstorm.Multiline = true;
            AttentionSandstorm.Name = "AttentionSandstorm";
            AttentionSandstorm.ReadOnly = true;
            AttentionSandstorm.ScrollBars = ScrollBars.Vertical;
            AttentionSandstorm.Size = new Size(600, 60);
            AttentionSandstorm.TabIndex = 58;
            AttentionSandstorm.Text = "≪ATTENTION≫ Meta -Train │ ☠Lvl 80 │ “Sandstorm!” │ ☣[&BIAHAAA=]☣ - Join us!";
            // 
            // Sandstorminstance
            // 
            Sandstorminstance.Font = new Font("Segoe UI", 15F);
            Sandstorminstance.Location = new Point(653, 439);
            Sandstorminstance.Multiline = true;
            Sandstorminstance.Name = "Sandstorminstance";
            Sandstorminstance.ReadOnly = true;
            Sandstorminstance.ScrollBars = ScrollBars.Vertical;
            Sandstorminstance.Size = new Size(600, 60);
            Sandstorminstance.TabIndex = 57;
            Sandstorminstance.Text = "Go out of fight, then right click group 2 & join ☣Dry Top☣";
            // 
            // Sandstorminfo
            // 
            Sandstorminfo.BackColor = SystemColors.Highlight;
            Sandstorminfo.Font = new Font("Segoe UI", 15F);
            Sandstorminfo.Location = new Point(13, 439);
            Sandstorminfo.Multiline = true;
            Sandstorminfo.Name = "Sandstorminfo";
            Sandstorminfo.ReadOnly = true;
            Sandstorminfo.ScrollBars = ScrollBars.Vertical;
            Sandstorminfo.Size = new Size(600, 60);
            Sandstorminfo.TabIndex = 56;
            Sandstorminfo.Text = "☠Lvl 80 ≪Sandstorm!≫ │ ☣[&BIAHAAA=]☣";
            // 
            // button1
            // 
            ...
            Controls.Add(AttentionSandstorm);
            Controls.Add(Sandstorminstance);
            Controls.Add(Sandstorminfo);
        ...
        private TextBox AttentionSandstorm;
        private TextBox Sandstorminstance;
        private TextBox Sandstorminfo;
