namespace GW2FOX
{
    partial class Convergences
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Convergences));
            button9 = new Button();
            button8 = new Button();
            button7 = new Button();
            button5 = new Button();
            ...
            button3 = new Button();
            button2 = new Button();
            AttentionConvergences = new TextBox();
            Convergencesinstance = new TextBox();
            Convergencesinfo = new TextBox();
            button1 = new Button();
            Symbols = new TextBox();
            Welcome = new TextBox();
            Guild = new TextBox();
            ...
            // 
            // AttentionConvergences
            // 
            AttentionConvergences.Font = new Font("Segoe UI", 15F);
            AttentionConvergences.Location = new Point(1293, 439);
            AttentionConvergences.Multiline = true;
            AttentionConvergences.Name = "AttentionConvergences";
            AttentionConvergences.ReadOnly = true;
            AttentionConvergences.ScrollBars = ScrollBars.Vertical;
            AttentionConvergences.Size = new Size(600, 60);
            AttentionConvergences.TabIndex = 58;
            AttentionConvergences.Text = "≪ATTENTION≫ Meta -Train │ ☠Lvl 80 │ “Convergences” │ ☣[&BB8OAAA=]☣ - Join us!";
            // 
            // Convergencesinstance
            // 
            Convergencesinstance.Font = new Font("Segoe UI", 15F);
            Convergencesinstance.Location = new Point(653, 439);
            Convergencesinstance.Multiline = true;
            Convergencesinstance.Name = "Convergencesinstance";
            Convergencesinstance.ReadOnly = true;
            Convergencesinstance.ScrollBars = ScrollBars.Vertical;
            Convergencesinstance.Size = new Size(600, 60);
            Convergencesinstance.TabIndex = 57;
            Convergencesinstance.Text = "Go out of fight, then right click group 2 & join ☣The Wizard's Tower☣";
            // 
            // Convergencesinfo
            // 
            Convergencesinfo.BackColor = SystemColors.Highlight;
            Convergencesinfo.Font = new Font("Segoe UI", 15F);
            Convergencesinfo.Location = new Point(13, 439);
            Convergencesinfo.Multiline = true;
            Convergencesinfo.Name = "Convergencesinfo";
            Convergencesinfo.ReadOnly = true;
            Convergencesinfo.ScrollBars = ScrollBars.Vertical;
            Convergencesinfo.Size = new Size(600, 60);
            Convergencesinfo.TabIndex = 56;
            Convergencesinfo.Text = "☠Lvl 80 ≪Convergences≫ │ ☣[&BB8OAAA=]☣";
            // 
            // button1
            // 
            ...
            Controls.Add(AttentionConvergences);
            Controls.Add(Convergencesinstance);
            Controls.Add(Convergencesinfo);
        ...
        private TextBox AttentionConvergences;
        private TextBox Convergencesinstance;
        private TextBox Convergencesinfo;
