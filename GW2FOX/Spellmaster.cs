...
namespace GW2FOX
{
    public partial class Spellmaster : BaseForm
    {
        public Spellmaster()
        {
            InitializeComponent();
        ...
        private void Canopy_Click(object sender, EventArgs e)
        {
            Clipboard.SetText(Canopy.Text);
        ...
        private void button10_Click(object sender, EventArgs e)
        {
            try
            {
                string homepageUrl = "https://wiki.guildwars2.com/wiki/Night_and_the_Enemy";
