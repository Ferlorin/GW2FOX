...
namespace GW2FOX
{
    public partial class DoomloreShrine : BaseForm
    {
        ...
        private void Beheinfo_Click(object sender, EventArgs e)
        {
            ...
            Clipboard.SetText(DoomloreShrinenfo.Text);
        ...
        {
            // Copy the text from Mawinfo TextBox to the clipboard
            Clipboard.SetText(DoomloreShrineinstance.Text);
        ...
        {
            // Copy the text from Mawinfo TextBox to the clipboard
            Clipboard.SetText(AttentionDoomloreShrine.Text);
        ...
        private void button10_Click(object sender, EventArgs e)
        {
            try
            {
                string homepageUrl = "https://wiki.guildwars2.com/wiki/The_Haunting_of_Doomlore_Shrine";
