namespace GW2FOX
{
    partial class DoomloreShrine
    {
        ...
        private void InitializeComponent()
        {
            ...
            button3 = new Button();
            button2 = new Button();
            AttentionDoomloreShrine = new TextBox();
            DoomloreShrineinstance = new TextBox();
            DoomloreShrinenfo = new TextBox();
            button1 = new Button();
            Symbols = new TextBox();
            Welcome = new TextBox();
            Guild = new TextBox();
            ...
            // 
            // AttentionDoomloreShrine
            // 
            AttentionDoomloreShrine.Font = new Font("Segoe UI", 15F);
            AttentionDoomloreShrine.Location = new Point(1293, 439);
            AttentionDoomloreShrine.Multiline = true;
            AttentionDoomloreShrine.Name = "AttentionDoomloreShrine";
            AttentionDoomloreShrine.ReadOnly = true;
            AttentionDoomloreShrine.ScrollBars = ScrollBars.Vertical;
            AttentionDoomloreShrine.Size = new Size(600, 60);
            AttentionDoomloreShrine.TabIndex = 58;
            AttentionDoomloreShrine.Text = "≪ATTENTION≫ Meta -Train │ ☠Lvl 80 │ “Doomlore Shrine” │ ☣[&BA4MAAA=]☣ - Join us!";
            // 
            // DoomloreShrineinstance
            // 
            DoomloreShrineinstance.Font = new Font("Segoe UI", 15F);
            DoomloreShrineinstance.Location = new Point(653, 439);
            DoomloreShrineinstance.Multiline = true;
            DoomloreShrineinstance.Name = "DoomloreShrineinstance";
            DoomloreShrineinstance.ReadOnly = true;
            DoomloreShrineinstance.ScrollBars = ScrollBars.Vertical;
            DoomloreShrineinstance.Size = new Size(600, 60);
            DoomloreShrineinstance.TabIndex = 57;
            DoomloreShrineinstance.Text = "Go out of fight, then right click group 2 & join ☣Grothmar Valley☣";
            // 
            // DoomloreShrinenfo
            // 
            DoomloreShrinenfo.BackColor = SystemColors.Highlight;
            DoomloreShrinenfo.Font = new Font("Segoe UI", 15F);
            DoomloreShrinenfo.Location = new Point(13, 439);
            DoomloreShrinenfo.Multiline = true;
            DoomloreShrinenfo.Name = "DoomloreShrinenfo";
            DoomloreShrinenfo.ReadOnly = true;
            DoomloreShrinenfo.ScrollBars = ScrollBars.Vertical;
            DoomloreShrinenfo.Size = new Size(600, 60);
            DoomloreShrinenfo.TabIndex = 56;
            DoomloreShrinenfo.Text = "☠Lvl 80 ≪Doomlore Shrine│ ☣[&BA4MAAA=]☣";
            // 
            // button1
            // 
            ...
            Controls.Add(AttentionDoomloreShrine);
            Controls.Add(DoomloreShrineinstance);
            Controls.Add(DoomloreShrinenfo);
        ...
        private TextBox AttentionDoomloreShrine;
        private TextBox DoomloreShrineinstance;
        private TextBox DoomloreShrinenfo;
