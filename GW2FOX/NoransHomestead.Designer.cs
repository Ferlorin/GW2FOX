namespace GW2FOX
{
    partial class NoransHomestead
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(NoransHomestead));
            button9 = new Button();
            button8 = new Button();
            button7 = new Button();
            button5 = new Button();
            ...
            button3 = new Button();
            button2 = new Button();
            AttentionNewLoamhurst = new TextBox();
            NewLoamhurstinstance = new TextBox();
            NewLoamhurstinfo = new TextBox();
            button1 = new Button();
            Symbols = new TextBox();
            Welcome = new TextBox();
            Guild = new TextBox();
            ...
            // 
            // AttentionNewLoamhurst
            // 
            AttentionNewLoamhurst.Font = new Font("Segoe UI", 15F);
            AttentionNewLoamhurst.Location = new Point(1293, 439);
            AttentionNewLoamhurst.Multiline = true;
            AttentionNewLoamhurst.Name = "AttentionNewLoamhurst";
            AttentionNewLoamhurst.ReadOnly = true;
            AttentionNewLoamhurst.ScrollBars = ScrollBars.Vertical;
            AttentionNewLoamhurst.Size = new Size(600, 60);
            AttentionNewLoamhurst.TabIndex = 58;
            AttentionNewLoamhurst.Text = "≪ATTENTION≫ Meta -Train │ ☠Lvl 80 │ “Noran's Homestead” │ ☣[&BK8JAAA=]☣ - Join us!";
            // 
            // NewLoamhurstinstance
            // 
            NewLoamhurstinstance.Font = new Font("Segoe UI", 15F);
            NewLoamhurstinstance.Location = new Point(653, 439);
            NewLoamhurstinstance.Multiline = true;
            NewLoamhurstinstance.Name = "NewLoamhurstinstance";
            NewLoamhurstinstance.ReadOnly = true;
            NewLoamhurstinstance.ScrollBars = ScrollBars.Vertical;
            NewLoamhurstinstance.Size = new Size(600, 60);
            NewLoamhurstinstance.TabIndex = 57;
            NewLoamhurstinstance.Text = "Go out of fight, then right click group 2 & join ☣Lake Doric☣";
            // 
            // NewLoamhurstinfo
            // 
            NewLoamhurstinfo.BackColor = SystemColors.Highlight;
            NewLoamhurstinfo.Font = new Font("Segoe UI", 15F);
            NewLoamhurstinfo.Location = new Point(13, 439);
            NewLoamhurstinfo.Multiline = true;
            NewLoamhurstinfo.Name = "NewLoamhurstinfo";
            NewLoamhurstinfo.ReadOnly = true;
            NewLoamhurstinfo.ScrollBars = ScrollBars.Vertical;
            NewLoamhurstinfo.Size = new Size(600, 60);
            NewLoamhurstinfo.TabIndex = 56;
            NewLoamhurstinfo.Text = "☠Lvl 80 ≪Noran's Homestead≫ │ ☣[&BK8JAAA=]☣";
            // 
            // button1
            // 
            ...
            Controls.Add(AttentionNewLoamhurst);
            Controls.Add(NewLoamhurstinstance);
            Controls.Add(NewLoamhurstinfo);
        ...
        private TextBox AttentionNewLoamhurst;
        private TextBox NewLoamhurstinstance;
        private TextBox NewLoamhurstinfo;
