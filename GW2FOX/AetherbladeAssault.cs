...
namespace GW2FOX
{
    public partial class AetherbladeAssault : BaseForm
    {
        ...
        private void Beheinfo_Click(object sender, EventArgs e)
        {
            ...
            Clipboard.SetText(AetherbladeAssaultinfo.Text);
        ...
        {
            // Copy the text from Mawinfo TextBox to the clipboard
            Clipboard.SetText(AetherbladeAssaultinstance.Text);
        ...
        {
            // Copy the text from Mawinfo TextBox to the clipboard
            Clipboard.SetText(AttentionAetherbladeAssault.Text);
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            try
            {
                string homepageUrl = "https://wiki.guildwars2.com/wiki/Aetherblade_Assault";
