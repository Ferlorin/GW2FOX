namespace GW2FOX
{
    partial class DefenseOfAmnytas
    {
        /// <summary>
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(DefenseOfAmnytas));
            button9 = new Button();
            button8 = new Button();
            button7 = new Button();
            button5 = new Button();
            ...
            button3 = new Button();
            button2 = new Button();
            AttentionDefenseOfAmnytas = new TextBox();
            DefenseOfAmnytasinstance = new TextBox();
            DefenseOfAmnytasinfo = new TextBox();
            button1 = new Button();
            Symbols = new TextBox();
            Welcome = new TextBox();
            Guild = new TextBox();
            ...
            // 
            // AttentionDefenseOfAmnytas
            // 
            AttentionDefenseOfAmnytas.Font = new Font("Segoe UI", 15F);
            AttentionDefenseOfAmnytas.Location = new Point(1293, 439);
            AttentionDefenseOfAmnytas.Multiline = true;
            AttentionDefenseOfAmnytas.Name = "AttentionDefenseOfAmnytas";
            AttentionDefenseOfAmnytas.ReadOnly = true;
            AttentionDefenseOfAmnytas.ScrollBars = ScrollBars.Vertical;
            AttentionDefenseOfAmnytas.Size = new Size(600, 60);
            AttentionDefenseOfAmnytas.TabIndex = 58;
            AttentionDefenseOfAmnytas.Text = "≪ATTENTION≫ Meta -Train │ ☠Lvl 80 │ “The Defense of Amnytas” │ ☣[&BDQOAAA=]☣ - Join us!";
            // 
            // DefenseOfAmnytasinstance
            // 
            DefenseOfAmnytasinstance.Font = new Font("Segoe UI", 15F);
            DefenseOfAmnytasinstance.Location = new Point(653, 439);
            DefenseOfAmnytasinstance.Multiline = true;
            DefenseOfAmnytasinstance.Name = "DefenseOfAmnytasinstance";
            DefenseOfAmnytasinstance.ReadOnly = true;
            DefenseOfAmnytasinstance.ScrollBars = ScrollBars.Vertical;
            DefenseOfAmnytasinstance.Size = new Size(600, 60);
            DefenseOfAmnytasinstance.TabIndex = 57;
            DefenseOfAmnytasinstance.Text = "Go out of fight, then right click group 2 & join ☣Amnytas☣";
            // 
            // DefenseOfAmnytasinfo
            // 
            DefenseOfAmnytasinfo.BackColor = SystemColors.Highlight;
            DefenseOfAmnytasinfo.Font = new Font("Segoe UI", 15F);
            DefenseOfAmnytasinfo.Location = new Point(13, 439);
            DefenseOfAmnytasinfo.Multiline = true;
            DefenseOfAmnytasinfo.Name = "DefenseOfAmnytasinfo";
            DefenseOfAmnytasinfo.ReadOnly = true;
            DefenseOfAmnytasinfo.ScrollBars = ScrollBars.Vertical;
            DefenseOfAmnytasinfo.Size = new Size(600, 60);
            DefenseOfAmnytasinfo.TabIndex = 56;
            DefenseOfAmnytasinfo.Text = "☠Lvl 80 ≪The Defense of Amnytas≫ │ ☣[&BDQOAAA=]☣";
            // 
            // button1
            // 
            ...
            Controls.Add(AttentionDefenseOfAmnytas);
            Controls.Add(DefenseOfAmnytasinstance);
            Controls.Add(DefenseOfAmnytasinfo);
        ...
        private TextBox AttentionDefenseOfAmnytas;
        private TextBox DefenseOfAmnytasinstance;
        private TextBox DefenseOfAmnytasinfo;
